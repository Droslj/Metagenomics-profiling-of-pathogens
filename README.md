...
**Keywords**<br>
Nextflow (nf-core) pipeline orchestration, Cloud infrastructure (Seqera/GCP), Troubleshooting resource allocation for high-memory tasks, Functional annotation, Identifying pathogenic virulence factors, Virulence factors, Toxin-Antitoxin (TA) system, Hemolysin
...
Antimicrobial peptide & envelope modification

3. L-Ara4N lipid A modification: arnA, arnB, arnC, arnT — modifies lipid A (LPS) to reduce negative charge and decrease peptide binding.
